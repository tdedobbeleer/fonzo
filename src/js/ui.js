(function ($, aos) {
    var LANG_EN = {
        ...
        'nav.contact': 'Contact',
        'title.reservations' : 'Sit your ass down',
        'text.reservations' : 'Some explanations regarding the reservations, Lorum ipswitch etc. Or Luton, wherever the parrot is. <br/><a href="https://wa.me/message/DHE4A3W3TPP2P1">Book via <i class="fab fa-whatsapp"></i></a>',
